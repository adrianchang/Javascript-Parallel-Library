...
/** @type {function(...*):?} */
var _simdFloatAdd = Module["_simdFloatAdd"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["simdFloatAdd"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _simdIntAdd = Module["_simdIntAdd"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["simdIntAdd"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _multiply_arrays = Module["_multiply_arrays"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["multiply_arrays"].apply(null, arguments)
};
